...
const DEFAULT_TIPS: Tip[] = [
  ...
  {
    category: '🎯 指示の精度UP',
    tip: '「〜してはいけない」より「〜してください」と肯定形で指示すると、AIがより正確に意図を理解します。',
    detail: '否定形の指示はAIが誤解しやすい傾向があります。例えば「難しい言葉を使わないで」より「小学生でもわかる言葉で書いて」のほうが意図通りの結果が得られます。肯定形＋具体的な条件の組み合わせが最強です。',
    tag: '初級', tagColor: '#4ade80', addedAt: '2026-03-24',
  },
  {
    category: '🎯 指示の精度UP',
    tip: '回答の最後に「この回答で不明な点や改善できる点はありますか？」と自己評価させると、品質が自動的に上がります。',
    detail: 'AIに自分の回答を批評させる「セルフクリティーク」技法です。特に重要な文書や提案書を作る際に有効で、見落としや矛盾点を自動的に発見してくれます。',
    tag: '中級', tagColor: '#f5a623', addedAt: '2026-03-24',
  },
  {
    category: '🔗 ワークフロー連携',
    tip: '長い作業は「まず構成案だけ出して」→確認→「では本文を書いて」と分割すると、手戻りが激減します。',
    detail: '一度に完成品を求めると、方向性がズレたときに全部やり直しになります。構成→本文→推敲と段階的に確認しながら進めることで、修正コストを最小化できます。特に5000字以上の長文作成で効果絶大です。',
    tag: '中級', tagColor: '#f5a623', addedAt: '2026-03-24',
  },
  {
    category: '🔗 ワークフロー連携',
    tip: '複数のAIツールを組み合わせる際は「前のAIの出力をそのまま貼り付け」るだけで引き継ぎができます。',
    detail: 'xLUMINAのWeb情報収集→文章作成、ディープリサーチ→AI分析エンジンのように、前の出力を次の入力にそのまま使う「パイプライン思考」が効率化の鍵です。コピー&ペーストだけで高度なワークフローが組めます。',
    tag: '初級', tagColor: '#4ade80', addedAt: '2026-03-24',
  },
  {
    category: '📊 ビジネス活用',
    tip: '会議の議事録をAIに渡して「アクションアイテムと担当者と期限を表形式で整理して」と依頼すると、即座にタスク管理表が完成します。',
    detail: '議事録の整理だけでなく「この議事録から次回議題のアジェンダを作って」「決定事項を関係者向けのメールにまとめて」など、1つの議事録から複数のアウトプットを生成できます。会議後の作業時間が80%削減できます。',
    tag: '中級', tagColor: '#f5a623', addedAt: '2026-03-24',
  },
  {
    category: '📊 ビジネス活用',
    tip: '競合他社のWebサイトのテキストをコピーしてAIに渡すと、自社との差別化ポイントを即座に分析してくれます。',
    detail: '「このテキストは競合A社のサービス説明です。我々の強みである○○と比較して、差別化できるポイントを5つ挙げてください」のように具体的な自社情報を添えると、実際の営業・マーケで使えるレベルの分析が得られます。',
    tag: '上級', tagColor: '#f87171', addedAt: '2026-03-24',
  },
  {
    category: '✨ 2026年最新テク',
    tip: 'AIに「悪魔の代弁者として反論して」と依頼すると、自分では気づけないアイデアの弱点を事前に発見できます。',
    detail: 'プレゼンや企画書を提出する前に「この提案に対して、経営陣が懸念しそうな反論を5つ挙げてください」と依頼しましょう。想定外の質問に備えられるだけでなく、企画そのものの完成度も上がります。2026年の意思決定支援AIの標準的な使い方として注目されています。',
    tag: '重要', tagColor: '#a89fff', addedAt: '2026-03-24',
  },
  {
    category: '✨ 2026年最新テク',
    tip: 'AIとの会話履歴を「プロジェクトのコンテキスト」として保存しておくと、次回から説明ゼロで続きから始められます。',
    detail: 'xLUMINAのリサーチ保存機能を使って、重要なAIとの対話結果を保存しておきましょう。「前回の分析結果：〜」と冒頭に貼るだけで、AIが即座に状況を把握して深い議論ができます。これがAI活用上級者の必須習慣です。',
    tag: '重要', tagColor: '#a89fff', addedAt: '2026-03-24',
  },
];
