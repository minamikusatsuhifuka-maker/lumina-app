...
const DEFAULT_TIPS: Tip[] = [
  ...
  },
  {
    ...
    detail: 'LUMINAのWeb情報収集→文章作成、ディープリサーチ→AI分析エンジンのように、前の出力を次の入力にそのまま使う「パイプライン思考」が効率化の鍵です。コピー&ペーストだけで高度なワークフローが組めます。',
    tag: '初級', tagColor: '#4ade80', addedAt: '2026-03-24',
  },
  {
    category: '📊 ビジネス活用',
  ...
  },
  {
    ...
    detail: 'LUMINAのライブラリ機能を使って、重要なAIとの対話結果を保存しておきましょう。「前回の分析結果：〜」と冒頭に貼るだけで、AIが即座に状況を把握して深い議論ができます。これがAI活用上級者の必須習慣です。',
    tag: '重要', tagColor: '#a89fff', addedAt: '2026-03-24',
  },
];
