...
- 📆 記事→X時間差展開: note記事1本から5型のX投稿を作り、選んだものだけを間隔を空けて日程に割り当て（被り警告つき）
- 📈 発信戦略: DR記事群からターゲティング・投稿スケジュール・note⇄X⇄Kindle導線を提案（🗃保存一覧へ保存可）
- 🗓 予約投稿カレンダー: note記事を平日の朝7:30/夜20:30に割り当てた表を作成（予約の実行はnote側）
- 🗺 収益化ロードマップ: 現在地のフェーズと今やることを決定的に表示。有料化候補・Kindle化の導線つき
- 📖 Kindle→note展開: 書籍の章×ペルソナ×切り口でnote記事を書き下ろし（公開前に元の章との目視確認を）
