    ...
    <div style={{ maxWidth: 720 }}>
      ...
      >
        ...
        <p style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 16, lineHeight: 1.7 }}>
          ...
          <br />
          <strong>既定はオフ</strong>です（全端末）。スマホでは本文の途中を長押しすると
          「選択／すべてを選択／ペースト」のメニューが出て狙いにくいため、
          置き換えは<strong>「✕ クリア」→「📋 ここを長押し →「ペースト」」の2操作</strong>を
          主な使い方にしています。この設定は、貼り付けだけで置き換わる方が好みの方のために残しています。
        </p>
