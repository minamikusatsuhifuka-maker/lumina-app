        ...
        <div style={{ background: 'var(--bg-secondary)', border: '1px solid rgba(0,212,184,0.2)', borderRadius: 12, padding: 24 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              <button onClick={() => { copyRichMarkdown(result); setToast('✅ コピーしました！'); setTimeout(() => setToast(''), 2000); }} style={{ padding: '6px 14px', background: 'var(--bg-secondary)', border: '1px solid var(--border)', color: 'var(--text-secondary)', borderRadius: 6, cursor: 'pointer', fontSize: 12 }}>
                📋 コピー
              </button>
              <button
